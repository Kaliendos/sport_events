...
Revision ID: f28a1f7fe0ab
Revises: d839f764ec10
Create Date: 2023-08-29 15:31:26.760423
...
revision = 'f28a1f7fe0ab'
down_revision = 'd839f764ec10'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    #op.create_foreign_key(None, 'comment', 'user', ['owner_id'], ['id'], ondelete='CASCADE')
    op.add_column('user', sa.Column('first_name', sa.String(length=50)))
    op.add_column('user', sa.Column('last_name', sa.String(length=50)))
    op.add_column('user', sa.Column('date_of_birth', sa.Date()))
    op.add_column('user', sa.Column('avatar_image_path', sa.String(length=300), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('user', 'avatar_image_path')
    op.drop_column('user', 'date_of_birth')
    op.drop_column('user', 'last_name')
    op.drop_column('user', 'first_name')
    op.create_index('datetime_idx', 'event', ['datetime'], unique=False)
