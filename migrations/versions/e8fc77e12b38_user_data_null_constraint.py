"""user_data_null_constraint

Revision ID: e8fc77e12b38
Revises: f28a1f7fe0ab
Create Date: 2023-08-29 15:43:57.023063
...
revision = 'e8fc77e12b38'
down_revision = 'f28a1f7fe0ab'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('user', 'date_of_birth',
               ...
               nullable=False)
    op.alter_column('user', 'avatar_image_path',
