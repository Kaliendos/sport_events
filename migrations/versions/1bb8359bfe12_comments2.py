...
Revision ID: 1bb8359bfe12
Revises: 0a2a3bc15503
Create Date: 2023-08-04 17:45:56.012510
...
revision = '1bb8359bfe12'
down_revision = '0a2a3bc15503'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('comment', sa.Column('author_id', sa.UUID(), nullable=True))
