...
Revision ID: 3be259e803c7
Revises: 1bb8359bfe12
Create Date: 2023-08-04 17:51:26.702340
...
revision = '3be259e803c7'
down_revision = '1bb8359bfe12'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('comment', sa.Column('text', sa.String(length=300), nullable=True))
