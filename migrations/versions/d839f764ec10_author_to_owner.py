...
Revision ID: d839f764ec10
Revises: 3be259e803c7
Create Date: 2023-08-11 22:56:40.856472
...
revision = 'd839f764ec10'
down_revision = '3be259e803c7'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('comment', sa.Column('owner_id', sa.UUID(), nullable=True))
    op.drop_column('comment', 'author_id')
    op.drop_column('event', 'geom')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('event', sa.Column('geom', geoalchemy2.types.Geometry(srid=4326, spatial_index=False, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True), autoincrement=False, nullable=True))
    op.add_column('comment', sa.Column('author_id', sa.UUID(), autoincrement=False, nullable=True))
